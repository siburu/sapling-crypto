...
use crate::babyjubjub::{FixedGenerators, JubjubEngine, JubjubParams, Unknown, edwards::Point};
use crate::baby_util::{hash_to_scalar};
...
mod tests {
    ...
    use crate::babyjubjub::{JubjubBn256, fs::Fs, edwards};
